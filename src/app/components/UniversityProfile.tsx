          ...
          {[
            ...
            <button
              ...
              className={`inline-flex items-center whitespace-nowrap border-b-2 pb-4 text-xs font-bold uppercase tracking-widest transition-all -mb-[1px] ${
                activeTab === tab.id
                  ? "border-[var(--aur-primary)] text-[var(--aur-text)]"
                        ...
                        <div key={metric.label}>
                          ...
                          <div className="w-full h-2.5 bg-[var(--aur-surface-hover)] rounded-full overflow-hidden border border-[var(--aur-border)]">
                            <div
                              ...
                              className="h-full bg-[var(--aur-primary)] rounded-full"
                            />
                          </div>
                        </div>
                      ))}
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={idx} className={`rounded-3xl p-8 flex flex-col justify-between shadow-sm transition-transform hover:-translate-y-1 ${
                    metric.highlight 
                      ? "bg-[var(--aur-primary)] text-[var(--aur-primary-text)]" 
                      : "border border-[var(--aur-border)] bg-[var(--aur-surface)]"
                  }`}>
                    <span className={`block text-[10px] uppercase font-bold tracking-widest mb-4 ${
                      metric.highlight ? "text-[var(--aur-primary-text)] opacity-70" : "text-[var(--aur-text-muted)]"
                    }`}>
                      {metric.label}
                    </span>
                    <span className={`text-4xl font-black font-serif ${
                      metric.highlight ? "text-[var(--aur-primary-text)]" : "text-[var(--aur-text)]"
                    }`}>
                  ...
                  <ul className="divide-y divide-[var(--aur-border)] border border-[var(--aur-border)] rounded-3xl bg-[var(--aur-surface)] overflow-hidden shadow-sm">
                    {uni.subjects.map((sub, idx) => (
                      <li key={idx} className="px-6 py-5 flex items-center text-sm font-bold text-[var(--aur-text)] hover:bg-[var(--aur-surface-hover)] transition-colors">
                        <div className="h-2 w-2 rounded-full bg-[var(--aur-primary)] opacity-40 mr-4" />
                        {sub}
                      </li>
                    ))}
                  </ul>
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10 mb-6">
                  ...
                  {!showEligibility && !eligibilityResult && (
                    <button 
                      ...
                      className="bg-[var(--aur-primary)] text-[var(--aur-primary-text)] hover:opacity-80 font-bold text-xs uppercase tracking-wider py-3 px-6 rounded-xl transition-all shadow-md shrink-0 w-full md:w-auto text-center"
                    >
                      Calculate Chances
                    </button>
                  )}
                  ...
                  <div className="animate-fadeIn mt-8 pt-6 border-t border-[var(--aur-border)] relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                      <div>
                        ...
                        <input type="text" placeholder="e.g. 92% or 3.8 GPA" className="w-full bg-[var(--aur-surface-2)] border border-[var(--aur-border)] rounded-xl px-4 py-3 text-sm font-bold text-[var(--aur-text)] placeholder-[var(--aur-text-muted)] focus:outline-none focus:border-[var(--aur-primary)] transition-colors" />
                      </div>
                      <div>
                        ...
                        <input type="text" placeholder="e.g. SAT 1450" className="w-full bg-[var(--aur-surface-2)] border border-[var(--aur-border)] rounded-xl px-4 py-3 text-sm font-bold text-[var(--aur-text)] placeholder-[var(--aur-text-muted)] focus:outline-none focus:border-[var(--aur-primary)] transition-colors" />
                      </div>
                      <div>
                        ...
                        <select className="w-full bg-[var(--aur-surface-2)] border border-[var(--aur-border)] rounded-xl px-4 py-3 text-sm font-bold text-[var(--aur-text)] focus:outline-none focus:border-[var(--aur-primary)] transition-colors cursor-pointer appearance-none">
                    ...
                    <div className="flex gap-3 justify-end">
                      ...
                      <button 
                        ...
                        className="bg-[var(--aur-primary)] text-[var(--aur-primary-text)] hover:opacity-80 font-bold text-xs uppercase tracking-wider py-3 px-8 rounded-xl transition-all shadow-md"
                      >
                        Analyze Profile
                      </button>
                    </div>
