          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center md:items-end gap-4 sm:gap-6 md:gap-8 text-white w-full">
            ...
            <div className="flex-grow flex flex-col md:flex-row justify-between items-center md:items-end w-full pb-1 sm:pb-2">
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-4 sm:mt-6 md:mt-0 shrink-0">
                <button className="bg-white text-black hover:bg-gray-100 font-bold px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl text-[10px] sm:text-xs uppercase tracking-wider transition-colors shadow-lg">
                  Apply with QS
                </button>
                <button 
                  onClick={() => onToggleSave(universityId)}
                  className={`${isShortlisted ? "bg-red-500 text-white" : "bg-black/50 hover:bg-black/70 text-white border border-white/20"} font-bold px-4 sm:px-5 py-2.5 sm:py-3 rounded-xl text-[10px] sm:text-xs uppercase tracking-wider flex items-center gap-2 transition-all shadow-lg backdrop-blur-sm`}>
                  <Bookmark className={`h-4 w-4 ${isShortlisted ? "fill-current" : ""}`} /> {isShortlisted ? "Saved" : "Save"}
                </button>
                <button 
                  onClick={() => onViewChange("rankings")}
                  className="bg-black/50 hover:bg-black/70 text-white border border-white/20 font-bold px-4 sm:px-5 py-2.5 sm:py-3 rounded-xl text-[10px] sm:text-xs uppercase tracking-wider flex items-center gap-2 transition-all shadow-lg backdrop-blur-sm">
