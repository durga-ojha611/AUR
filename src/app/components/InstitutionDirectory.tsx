  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex-1 flex flex-col justify-between">
        <div>
          <h3 className="font-serif text-[16px] font-bold text-slate-900 group-hover:text-[#94061e] transition-colors leading-snug line-clamp-2">
            {uni.name}
          </h3>
    ...
    <div className="w-full min-h-screen bg-slate-50/60 pb-12">
          ...
          <div className="flex flex-wrap gap-2.5 items-center">
            ...
            <button
              ...
              className={`text-[11px] font-bold px-3.5 py-2 rounded-lg border transition-all flex items-center gap-1.5 ${
                showEligibility
                  ? "bg-amber-500 text-white border-[#94061e] shadow-sm"
                  : "bg-slate-50 text-slate-500 border-slate-200 hover:border-amber-400 hover:text-[#94061e]"
              }`}
            >
      ...
      {showEligibility && (
        <div className="max-w-6xl mx-auto px-4 md:px-8 pt-6">
          <div className="bg-white border border-gray-200 shadow-[0_8px_30px_rgba(251,191,36,0.12)] rounded-2xl p-6 relative">
            <button 
            ...
            <div className="flex items-center gap-2 mb-4">
              <div className="bg-gray-100 p-2 rounded-lg text-[#94061e]">
        ...
        {filtered.length === 0 ? (
          <div className="py-20 text-center bg-white rounded-2xl border border-slate-100 max-w-lg mx-auto mt-6">
            ...
            <button
              ...
              className="mt-3 text-amber-500 text-[12px] font-bold hover:text-[#94061e] underline underline-offset-2"
            >
              Clear filters
            </button>
          </div>
