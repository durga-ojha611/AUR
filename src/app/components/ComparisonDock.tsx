        ...
        <div className="aur-panel border-slate-900/10 dark:border-cyber-yellow/20 p-3 sm:p-4 flex items-center justify-between">
          <div className="flex items-center space-x-2 sm:space-x-4 truncate">
            ...
            <div className="truncate">
              <span className="inline-block text-[9px] uppercase font-bold tracking-widest text-[#94061e] bg-gray-50 border border-gray-200 px-1.5 py-0.5 rounded-xs">
                Comparison Suite
              </span>
          ...
          <div className="fixed inset-y-10 inset-x-4 md:inset-x-12 lg:inset-x-24 bg-white border border-slate-950 flex flex-col justify-between shadow-2xl z-50">
            ...
            <div className="p-6 border-b border-slate-200 bg-white">
              <div className="flex items-center justify-between">
                <div>
                  <span className="text-[10px] uppercase font-bold tracking-widest text-[#94061e]">
                      ...
                      <div className="border-b border-slate-100 pb-4 mb-6">
                        <div className="flex justify-between items-start">
                          <h4 
                            ...
                            className="font-sans text-sm font-bold text-slate-900 hover:text-[#94061e] cursor-pointer transition-colors leading-tight truncate"
                          >
                            {uni.name}
                          </h4>
                          <button
