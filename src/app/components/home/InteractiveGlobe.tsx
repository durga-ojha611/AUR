      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center">
        ...
        htmlElement={(d: any) => {
          ...
          el.innerHTML = `
            ...
            <div class="relative bg-slate-900/95 backdrop-blur-md border border-slate-700 rounded-xl p-3 shadow-2xl group-hover:border-[#94061e] transition-colors cursor-pointer">
              <p class="text-[12px] font-semibold text-white leading-tight line-clamp-2 mb-1">${d.name}</p>
              <p class="text-[9px] font-medium text-[#94061e] uppercase tracking-wider mb-2">#${d.rank} in Asia</p>
