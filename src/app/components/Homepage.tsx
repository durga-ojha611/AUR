...
function highlightMatch(text: string, query: string) {
  ...
  return (
    <>
      {text.slice(0, idx)}
      <mark className="bg-gray-100 text-amber-800 px-0.5">{text.slice(idx, idx + q.length)}</mark>
                      ...
                      <>
                                ...
                                return (
                                  <li key={uni.id}>
                                    <button
                                      ...
                                      className={`w-full text-left flex justify-between p-2 text-xs rounded ${active ? "bg-gray-50" : "hover:bg-slate-50"}`}
                                    >
                        ...
                        <div className="p-2 text-center">
                          <button
                            ...
                            className="text-[11px] text-[#94061e] font-semibold uppercase tracking-wider"
                          >
            ...
            <div className="mt-4 flex flex-wrap gap-2 items-center justify-center mb-10">
              ...
              {["Uzbekistan", "Medicine", "National Univ Singapore", "English medium"].map((tag) => (
                <button
                  ...
                  className="text-[10px] px-2.5 py-1 rounded-full border border-gray-200 bg-white text-slate-600 hover:border-amber-400 hover:bg-gray-50 hover:text-amber-900 transition-colors"
                >
                  {tag}
                </button>
              ))}
          ...
          {displayedArticles.map((article) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <h3 className="font-bold text-sm mt-2 mb-2 line-clamp-2 group-hover:text-[#94061e] transition-colors">
                  {article.title}
                </h3>
        ...
        <div className="ref-footer-grid">
          <div>
            <div className="font-bold text-lg mb-2">
              ASIA <span className="text-[#94061e]">UNIVERSITY</span> RANKINGS
            </div>
                ...
                {col.links.map(([label, view]) => (
                  <li key={label}>
                    <button
                      ...
                      className="text-xs text-[var(--ref-muted)] hover:text-[#94061e] transition-colors"
                    >
                      {label}
                    </button>
                  </li>
