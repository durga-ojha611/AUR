...
export default function Login() {
  ...
  const handleSocialLogin = (provider: string) => {
    ...
    // BACKEND TEAM: Provide the OAuth redirect URLs for these providers.
    // Example: window.location.href = `/api/v1/auth/${provider}`;
            ...
            >
              ...
              <form className="lp-form" onSubmit={handleSubmit}>
                ...
                <div className="lp-social-row">
                  <button type="button" className="lp-social-btn" onClick={() => handleSocialLogin('google')}>
