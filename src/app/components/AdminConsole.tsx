    ...
    <div className="min-h-screen bg-[var(--background)] flex flex-col font-sans">
      ...
      <header className="sticky top-0 z-50 bg-[var(--aur-surface)]/80 backdrop-blur-xl border-b border-[var(--aur-border)] px-6 lg:px-10 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="h-10 w-10 bg-[var(--aur-primary)] text-[var(--aur-primary-text)] rounded-xl flex items-center justify-center shadow-sm">
            ...
            {[
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-bold transition-all ${
                  activeTab === item.id 
                    ? "bg-[var(--aur-primary)] text-[var(--aur-primary-text)] shadow-md" 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div className="aur-card p-6">
                      <div className="flex justify-between items-start mb-4">
                        <div className="h-8 w-8 rounded-full bg-blue-500/10 text-[#94061e] dark:text-[#94061e] flex items-center justify-center">
                    ...
                    <div className="aur-card p-6">
                      <div className="flex justify-between items-start mb-4">
                        <div className="h-8 w-8 rounded-full bg-amber-500/10 text-[#94061e] dark:text-[#94061e] flex items-center justify-center">
                            ...
                            <tr key={event.id} className="hover:bg-[var(--aur-surface-hover)] transition-colors">
                              ...
                              <td className="px-6 py-4">
                                <span className={`inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-bold uppercase tracking-wider ${
                                  ...
                                  event.status === 'warning' ? 'bg-amber-500/10 text-[#94061e] dark:text-[#94061e] border border-[#94061e]/20' :
                ...
                <div className="max-w-2xl">
                  <div className="aur-card p-6 md:p-8">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="h-12 w-12 rounded-2xl bg-[var(--aur-primary)] text-[var(--aur-primary-text)] flex items-center justify-center shadow-sm">
                    ...
                    <form onSubmit={handleApplyOverride} className="space-y-6">
                      ...
                      <div className="bg-amber-500/5 border border-[#94061e]/20 rounded-xl p-4 flex gap-3">
                        <AlertCircle className="h-5 w-5 text-[#94061e] dark:text-[#94061e] flex-shrink-0" />
