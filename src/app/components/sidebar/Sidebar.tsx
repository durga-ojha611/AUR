    ...
    >
              ...
              >
                ...
                {isActive && (
                  <div
                    ...
                    className="absolute inset-0 bg-[var(--aur-primary)] shadow-sm rounded-lg z-[-1]"
      ...
      <div className="p-4 pb-12 border-t border-[var(--aur-border)] flex justify-center">
        <button
          ...
          className="p-2 rounded-lg border transition-all duration-150 cursor-pointer border-[var(--aur-border)] text-[var(--aur-text-secondary)] hover:bg-[var(--aur-primary)] hover:text-[var(--aur-primary-text)] hover:border-[var(--aur-primary)]"
