    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className={`w-full h-full rounded-full flex items-center justify-center bg-slate-950/90 dark:bg-cyber-gray/95 border-2 border-[#94061e]/50 dark:border-cyber-yellow/60 shadow-[0_4px_25px_rgba(180,83,9,0.3)] dark:shadow-[0_0_20px_rgba(234,179,8,0.2)] backdrop-blur-md relative overflow-hidden transition-shadow ${
              isDragging
            ...
            >
              {isOpen ? (
                ...
                <div className="relative flex items-center justify-center">
                  ...
                  <Sparkles className="h-3.5 w-3.5 absolute -top-1.5 -right-1.5 text-[#94061e] dark:text-cyber-yellow-bright animate-bounce" />
                </div>
              )}
            </div>
          </div>
            ...
            >
              <div className="p-4 border-b border-slate-200/60 dark:border-cyber-border/40 bg-slate-50/50 dark:bg-cyber-gray/40 flex items-center justify-between">
                <div className="flex items-center space-x-2.5">
                  <div className="w-8 h-8 rounded-full bg-amber-700/10 dark:bg-cyber-yellow/10 flex items-center justify-center text-[#94061e] dark:text-cyber-yellow">
                  ...
                  <div>
                    <h3 className="font-serif text-sm font-bold text-slate-900 dark:text-white flex items-center gap-1.5">
                      ...
                      <Sparkles className="h-3 w-3 text-[#94061e] dark:text-cyber-yellow animate-pulse" />
                    </h3>
