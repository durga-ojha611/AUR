...
export default function MobileMenu() {
  ...
  return (
    <>
        ...
        {isMobileOpen && (
          <div className="fixed inset-0 z-50 md:hidden flex font-sans">
            ...
            <div
              ...
              className="relative w-80 max-w-[85vw] h-full flex flex-col shadow-2xl z-10 bg-white text-slate-900 border-r border-slate-200"
            >
              {/* Drawer Header */}
      ...
      <nav
        className="md:hidden fixed bottom-0 left-0 right-0 h-16 border-t z-40 transition-colors duration-200 bg-white/95 border-slate-200 text-slate-500 pb-safe-bottom"
      >
