              ...
              <div className="p-4 border-b border-slate-200 dark:border-cyber-border/40 flex items-center justify-between">
                <div>
                  <h3 className="font-serif text-sm font-bold tracking-tight text-slate-900 dark:text-white">
                    ASIA UNIVERSITY <span className="text-[#94061e] dark:text-cyber-yellow text-[10px] font-sans font-bold">PORTAL</span>
                  </h3>
                    ...
                    {SIDEBAR_ITEMS.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {item.badge && (
                            <span className="ml-auto text-[8px] font-mono px-1.5 py-0.5 rounded font-bold uppercase bg-gray-100 text-amber-900 dark:bg-cyber-black dark:text-cyber-yellow border dark:border-cyber-yellow/20">
                              {item.badge}
                            </span>
                          )}
                        </button>
        ...
        <div className="h-full grid grid-cols-4 items-center max-w-lg mx-auto">
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center h-full transition-colors ${
              activeView === "home"
                ? "text-[#94061e] dark:text-cyber-yellow"
