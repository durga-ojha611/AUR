            ...
            return (
              <button
                ...
                className={`p-4 rounded-xl text-left border transition-all duration-200 ${
                  isSelected
                    ? "bg-[var(--aur-primary)] border-[var(--aur-primary)] text-[var(--aur-primary-text)] shadow-md"
              ...
              >
                <span
                  className={`text-[10px] font-bold uppercase tracking-widest block mb-1 ${
                    isSelected
                      ? "text-[var(--aur-primary-text)] opacity-80"
                ...
                <span
                  className={`text-[10px] mt-1 block font-mono ${
                    isSelected
                      ? "text-[var(--aur-primary-text)] opacity-60"
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6 p-3 rounded-xl border border-[var(--aur-border)] bg-[var(--aur-surface-2)]">
        ...
        <button
          ...
          className={`flex items-center justify-center gap-2 text-xs font-bold uppercase tracking-wider px-5 h-[42px] rounded-lg border transition-all ${
            showMedicine
              ? "bg-[var(--aur-primary)] border-[var(--aur-primary)] text-[var(--aur-primary-text)]"
        ...
        <button
          ...
          className={`flex items-center justify-center gap-2 text-xs font-bold uppercase tracking-wider px-5 h-[42px] rounded-lg border transition-all ${
            showEligibility
              ? "bg-[var(--aur-primary)] border-[var(--aur-primary)] text-[var(--aur-primary-text)] shadow-sm"
              : "bg-[var(--aur-surface)] border-[var(--aur-border)] text-[var(--aur-text-secondary)] hover:bg-[var(--aur-surface-hover)] hover:text-[var(--aur-text)]"
          }`}
        >
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-5 relative z-10">
                ...
                <div className="flex items-end">
                  <button 
                    ...
                    className="w-full bg-[var(--aur-primary)] text-[var(--aur-primary-text)] hover:opacity-80 font-bold text-[11px] uppercase tracking-wider py-3.5 px-4 rounded-lg transition-all flex items-center justify-center gap-2 shadow-sm group"
                  >
            ...
            return (
              ...
              >
                ...
                <div className="relative h-44 overflow-hidden bg-[var(--aur-surface-2)]">
                  ...
                  {/* Medicine badge */}
                  {uni.hasMedicine && (
                    <div className="absolute top-3 right-3 flex items-center gap-1 bg-[var(--aur-primary)] text-[var(--aur-primary-text)] text-[9px] font-bold uppercase tracking-wider px-2 py-1 rounded-full shadow-lg">
                ...
                <div className="flex items-center gap-2 px-4 py-2.5 border-b border-[var(--aur-border)] bg-[var(--aur-surface)]">
                  ...
                  <button
                    ...
                    className={`flex flex-1 justify-center items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-md border transition-all ${
                      isCompared
                        ? "bg-[var(--aur-primary)] text-[var(--aur-primary-text)] border-[var(--aur-primary)]"
                        : "bg-[var(--aur-surface)] text-[var(--aur-text-secondary)] border-[var(--aur-border)] hover:bg-[var(--aur-surface-hover)]"
                    }`}
                  >
                ...
                <div className="px-4 py-4 flex-1 flex flex-col bg-[var(--aur-surface)]">
                  ...
                  <div className="mt-2 flex gap-2 border-t border-[var(--aur-border)] pt-4">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-2 text-xs font-bold uppercase tracking-wider py-2.5 rounded-lg bg-[var(--aur-primary)] text-[var(--aur-primary-text)] hover:opacity-90 transition-opacity"
                    >
                      View Profile
      ...
      {filteredUniversities.length === 0 && (
        <div className="text-center py-20 rounded-2xl border border-[var(--aur-border)] bg-[var(--aur-surface-2)] mt-6">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 border border-[var(--aur-primary)] bg-[var(--aur-primary)] px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-[var(--aur-primary-text)] hover:opacity-80 transition-opacity rounded-xl"
          >
      ...
      <div className="mt-12 p-8 rounded-2xl border border-[var(--aur-border)] bg-[var(--aur-surface-2)] text-center relative overflow-hidden">
        <div className="relative z-10">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 text-xs font-bold uppercase tracking-wider px-8 py-3 rounded-xl bg-[var(--aur-primary)] text-[var(--aur-primary-text)] hover:opacity-90 transition-opacity"
          >
