        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              ...
              className="inline-flex items-center justify-center rounded-full bg-gray-100 text-amber-800 dark:bg-cyber-yellow/15 dark:text-cyber-yellow text-[10px] font-semibold uppercase px-2 py-0.5"
            >
              {activeFilterCount}
            </span>
          </div>
