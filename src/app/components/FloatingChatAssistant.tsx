...
export default function FloatingChatAssistant() {
  ...
  const accent   = isDark ? "text-cyber-yellow" : "text-[#94061e]";
  ...
  const dragGlow = isDark
    ...
    : "shadow-[0_0_30px_rgba(245,158,11,0.25)] border-[#94061e]/40";
                  ...
                  {msg.role === "assistant" && (
                    <div
                      className={[
                        ...
                        isDark ? "bg-cyber-yellow/10" : "bg-gray-50 border border-gray-200",
                      ].join(" ")}
                    >
