            ...
            <div className="space-y-4">
              ...
              <form onSubmit={handleSubscribe} className="space-y-4">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-slate-700 bg-slate-900 px-4 py-3 text-sm text-slate-100 placeholder:text-slate-500 outline-none  duration-200 focus:border-[#94061e] focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-slate-950"
