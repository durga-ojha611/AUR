              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-bold uppercase tracking-wider transition-all duration-200 whitespace-nowrap lg:whitespace-normal relative z-10 ${
                    isActive ? "text-[var(--aur-primary-text)]" : "text-[var(--aur-text-muted)] hover:text-[var(--aur-text)] hover:bg-[var(--aur-hover)]"
                  }`}
                >
                  {isActive && (
                    <div
                      
                      className="absolute inset-0 bg-[var(--aur-primary)] rounded-xl z-[-1]"
            ...
            >
                  ...
                  {savedUniversities.length > 0 ? (
                    ...
                    <div className="py-16 flex flex-col items-center justify-center border border-dashed border-[var(--aur-border-strong)] rounded-xl text-center bg-[var(--aur-surface-2)]">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 border border-[var(--aur-primary)] bg-[var(--aur-primary)] px-5 py-2.5 text-[10px] font-bold uppercase tracking-widest text-[var(--aur-primary-text)] hover:opacity-80 transition-opacity rounded-lg"
                      >
                      ...
                      >
                        ...
                        <button
                          ...
                          className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[var(--aur-text)] focus:ring-offset-2 focus:ring-offset-[var(--background)] ${
                            option.state ? "bg-[var(--aur-primary)]" : "bg-[var(--aur-border-strong)]"
                          }`}
                        >
                          <span
              ...
              {activeTab === "billing" && (
                <div className="space-y-6">
                  ...
                  <div className="p-6 border border-[var(--aur-primary)] bg-[var(--aur-surface-2)] rounded-xl relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--aur-primary)] opacity-[0.03] rounded-bl-full pointer-events-none" />
                    <div className="inline-block px-2 py-1 bg-[var(--aur-primary)] text-[var(--aur-primary-text)] text-[9px] font-bold uppercase tracking-widest rounded mb-4">
                      Pro Tier
                    </div>
                    ...
                    <button className="bg-[var(--aur-primary)] text-[var(--aur-primary-text)] px-5 py-2.5 text-[10px] font-bold uppercase tracking-widest rounded-lg">
                      Manage Subscription
                    </button>
                  </div>
                </div>
