            ...
            <div className="p-6">
              {isSuccess ? (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-8">
                  ...
                  <button onClick={handleClose} className="w-full py-3 px-4 bg-[var(--aur-primary)] text-[var(--aur-primary-text)] rounded-xl font-bold uppercase tracking-widest text-xs hover:opacity-90 transition-opacity">
                    Done
                  </button>
                </motion.div>
              ) : (
                <>
                  ...
                  <div className="flex gap-2 mb-8">
                    {[1, 2, 3, 4].map((s) => (
                      <div key={s} className={`h-1.5 flex-1 rounded-full transition-colors ${s <= step ? "bg-[var(--aur-primary)]" : "bg-[var(--aur-border)]"}`} />
                    ))}
                  </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full bg-[var(--aur-surface-2)] border ${errors.institution ? "border-red-500 focus:border-red-500" : "border-[var(--aur-border)] focus:border-[var(--aur-primary)]"} rounded-xl py-3 pl-10 pr-4 text-sm text-[var(--aur-text)] focus:outline-none transition-colors`}
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full bg-[var(--aur-surface-2)] border ${errors.website ? "border-red-500 focus:border-red-500" : "border-[var(--aur-border)] focus:border-[var(--aur-primary)]"} rounded-xl py-3 pl-10 pr-4 text-sm text-[var(--aur-text)] focus:outline-none transition-colors`}
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full bg-[var(--aur-surface-2)] border ${errors.contactName ? "border-red-500 focus:border-red-500" : "border-[var(--aur-border)] focus:border-[var(--aur-primary)]"} rounded-xl py-3 pl-10 pr-4 text-sm text-[var(--aur-text)] focus:outline-none transition-colors`}
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full bg-[var(--aur-surface-2)] border ${errors.email ? "border-red-500 focus:border-red-500" : "border-[var(--aur-border)] focus:border-[var(--aur-primary)]"} rounded-xl py-3 pl-10 pr-4 text-sm text-[var(--aur-text)] focus:outline-none transition-colors`}
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full bg-[var(--aur-surface-2)] border ${errors.cardNumber ? "border-red-500 focus:border-red-500" : "border-[var(--aur-border)] focus:border-[var(--aur-primary)]"} rounded-xl py-3 pl-10 pr-4 text-sm text-[var(--aur-text)] focus:outline-none transition-colors`}
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`w-full bg-[var(--aur-surface-2)] border ${errors.expiry ? "border-red-500 focus:border-red-500" : "border-[var(--aur-border)] focus:border-[var(--aur-primary)]"} rounded-xl py-3 pl-10 pr-4 text-sm text-[var(--aur-text)] focus:outline-none transition-colors`}
                              placeholder="MM/YY"
                            />
                          </div>
                          <AnimatePresence>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`w-full bg-[var(--aur-surface-2)] border ${errors.cvv ? "border-red-500 focus:border-red-500" : "border-[var(--aur-border)] focus:border-[var(--aur-primary)]"} rounded-xl py-3 pl-10 pr-4 text-sm text-[var(--aur-text)] focus:outline-none transition-colors`}
                              placeholder="123"
                            />
                          </div>
                          <AnimatePresence>
            ...
            {!isSuccess && (
              <div className="p-6 border-t border-[var(--aur-border)] bg-[var(--aur-surface-2)] flex justify-between">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-[var(--aur-primary)] text-[var(--aur-primary-text)] rounded-lg text-sm font-bold uppercase tracking-widest hover:opacity-90 transition-opacity flex items-center justify-center min-w-[120px]"
                >
                  {isSubmitting ? (
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto px-4 md:px-0">
          ...
          <motion.div 
            ...
            className="bg-[var(--aur-primary)] border border-[var(--aur-primary)] rounded-3xl p-8 shadow-xl flex flex-col relative text-[var(--aur-primary-text)] transition-transform"
          >
            ...
            <div className="mb-6">
              <h2 className="text-2xl font-serif font-bold text-[var(--aur-primary-text)] flex items-center gap-2">
                Premium <Crown className="w-5 h-5" />
              </h2>
              <p className="text-[var(--aur-primary-text)]/70 text-sm mt-2">Advanced analytics and premium participation.</p>
            </div>
            <div className="text-3xl font-bold font-mono text-[var(--aur-primary-text)] mb-8">
              $5,000<span className="text-sm text-[var(--aur-primary-text)]/70 font-sans"> / year</span>
            </div>
            
            <ul className="space-y-5 mb-8 flex-1">
              <li className="flex items-start gap-4">
                <ShieldCheck className="w-5 h-5 text-[var(--aur-primary-text)]/70 shrink-0 mt-0.5" />
                <span className="text-sm font-medium text-[var(--aur-primary-text)]/90">Profile Verification Badge</span>
              </li>
              <li className="flex items-start gap-4">
                <Edit3 className="w-5 h-5 text-[var(--aur-primary-text)]/70 shrink-0 mt-0.5" />
                <span className="text-sm font-medium text-[var(--aur-primary-text)]/90">Institutional Data Update Submissions</span>
              </li>
              <li className="flex items-start gap-4">
                <BarChart3 className="w-5 h-5 text-[var(--aur-primary-text)]/70 shrink-0 mt-0.5" />
                <span className="text-sm font-medium text-[var(--aur-primary-text)]/90">Advanced Analytics Dashboard</span>
              </li>
              <li className="flex items-start gap-4">
                <Award className="w-5 h-5 text-[var(--aur-primary-text)]/70 shrink-0 mt-0.5" />
                <span className="text-sm font-medium text-[var(--aur-primary-text)]/90">Participation in Events and Awards</span>
              </li>
            </ul>
