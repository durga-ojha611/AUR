      ...
      <section className="ref-hero">
        <div className="ref-hero-grid">
          ...
          >
            ...
            <h1 className="ref-hero-title text-3xl sm:text-4xl lg:text-[2.75rem] font-bold leading-tight mt-3 mb-4">
              Asia&apos;s Most Trusted{" "}
              <span className="ref-hero-title-accent">University Intelligence</span> Platform
            </h1>
            <p className="ref-hero-deck text-[var(--ref-muted)] text-sm leading-relaxed max-w-lg mb-6">
            ...
            {/* Search */}
            <div className="ref-hero-search relative max-w-lg" ref={suggestionRef}>
            ...
            <div className="ref-trending-row mt-3 flex flex-wrap gap-2 items-center">
